...
def get_dinov2_s_model() -> tuple[nn.Module, tuple[int, int, int]]:
    """ViT-S-14."""
    return _get_dinov2_model('vits14')


def get_dinov2_b_model() -> tuple[nn.Module, tuple[int, int, int]]:
    """ViT-B-14."""
    return _get_dinov2_model('vitb14')


def get_dinov2_l_model() -> tuple[nn.Module, tuple[int, int, int]]:
    """ViT-L-14."""
    return _get_dinov2_model('vitl14')


def get_dinov2_g_model() -> tuple[nn.Module, tuple[int, int, int]]:
    """ViT-G-14."""
    return _get_dinov2_model('vitg14')


def get_dinov2_model() -> tuple[nn.Module, tuple[int, int, int]]:
    """Create default."""
